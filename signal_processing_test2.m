...
function [lowPassFreq, highPassFreq, rectifiedSignal] = phase2(soundClip, nChannels)
    ...
    %4
    lowPassFreq = [125, 190, 290, 390, 495, 620, 760, 905, 1075, 1240, 1470, 1720, 1980, 2320, 2670, 3110];
    highPassFreq = [210, 310, 410, 515, 640, 780, 925, 1095, 1260, 1490, 1730, 1990, 2330, 2690, 3130, 3655];
